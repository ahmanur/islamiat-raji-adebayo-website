...
export const LIST_DEFAULTS: Record<string, Array<Record<string, string>>> = {
  ...
  publications: [
    {
      title: 'The role of avian frugivores in the germination and dispersal of fleshy-fruited Ficus species in KwaZulu-Natal, South Africa',
      authors: 'Raji, I.A. & Downs, C.T.',
      journal: 'Journal of Ornithology',
      year: '2022',
      category: 'Journal Article',
      url: 'https://link.springer.com/article/10.1007/s10336-022-01963-8',
    },
    {
      title: 'Fruiting phenology and diversity of native Ficus species in an urban-forest mosaic landscape in KwaZulu-Natal, South Africa',
      authors: 'Raji, I.A. & Downs, C.T.',
      journal: 'African Journal of Ecology',
      year: '2022',
      category: 'Journal Article',
      url: 'https://onlinelibrary.wiley.com/doi/10.1111/aje.13017',
    },
    {
      title: 'Modification of the third phase in the framework for vertebrate species persistence in urban mosaic environments',
      authors: 'Raji, I.A. & Downs, C.T.',
      journal: 'Ambio',
      year: '2021',
      category: 'Journal Article',
    ...
    },
    {
      ...
      authors: 'Raji, I.A., Manu, S., Chaskda, A. & Pomeroy, D.',
      journal: 'Journal of Ornithology',
      year: '2021',
      category: 'Journal Article',
