...
const sections = [
  ...
  { href: '/admin/outreach', label: 'Contact Info', desc: 'Contact info and outreach text', icon: '🌍' },
  { href: '/admin/outreach-engagement', label: 'Outreach', desc: 'Public engagement and science writing', icon: '📣' },
